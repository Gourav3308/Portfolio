...
INSERT IGNORE INTO projects (title, description, long_description, github_url, live_url, featured, category, date, created_at, updated_at) VALUES
...
-- Insert project technologies (only if they don't exist)
...
INSERT IGNORE INTO skills (name, level, category, icon, color, created_at, updated_at) VALUES
