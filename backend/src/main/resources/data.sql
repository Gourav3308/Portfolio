...
('Java', 90, 'Languages', 'fab fa-java', '#f89820', CURDATE(), CURDATE()),
('Spring Boot', 85, 'Frameworks', 'fas fa-leaf', '#6db33f', CURDATE(), CURDATE()),
('React', 80, 'Frontend', 'fab fa-react', '#61dafb', CURDATE(), CURDATE()),
('JavaScript', 85, 'Languages', 'fab fa-js-square', '#f7df1e', CURDATE(), CURDATE()),
('MySQL', 80, 'Database', 'fas fa-database', '#4479a1', CURDATE(), CURDATE()),
('HTML/CSS', 90, 'Frontend', 'fab fa-html5', '#e34f26', CURDATE(), CURDATE()),
('Git', 75, 'Tools', 'fab fa-git-alt', '#f05032', CURDATE(), CURDATE()),
('REST APIs', 85, 'Backend', 'fas fa-code', '#8b5cf6', CURDATE(), CURDATE());
